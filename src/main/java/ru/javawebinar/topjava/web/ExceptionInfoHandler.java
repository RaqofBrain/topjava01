...
public class ExceptionInfoHandler {
    ...
    private static final String EXCEPTION_EMAIL_DUPLICATE = "exception.duplicate.email";
    private static final String EXCEPTION_DUPLICATE_DATETIME = "exception.duplicate.dateTime";
    private static final Map<String, String> CONSTRAINT_I18N_MAP = Map.of(
    ...
    public ErrorInfo conflict(HttpServletRequest req, DataIntegrityViolationException e) {
        ...
        if (rootMsg != null) {
            ...
            for (Map.Entry<String, String> entry : CONSTRAINT_I18N_MAP.entrySet()) {
    ...
    public ErrorInfo bindingError(HttpServletRequest req, BindException e) {
        ...
        return logAndGetErrorInfo(req, e, false, VALIDATION_ERROR, errorMessage);
    }
